...
// --- Definisi Konstanta ---
const ACTIVITY_GIFS = {
  'Work': '/UAS-PTI/assets/gifs/kerja.gif',
  'Eat': '/UAS-PTI/assets/gifs/makan.gif',
  'Use Consumable Item': '/UAS-PTI/assets/gifs/makan.gif',
  'Swim': '/UAS-PTI/assets/gifs/renang.gif',
  'Fishing': '/UAS-PTI/assets/gifs/mancing.gif',
  'Hike': '/UAS-PTI/assets/gifs/hiking.gif',
  'Sleep': '/UAS-PTI/assets/gifs/tidur.gif',
  'Take a Bath': '/UAS-PTI/assets/gifs/mandi.gif',
  'Buy Souvenir': '/UAS-PTI/assets/gifs/souvenir.gif',
  'Explore': '/UAS-PTI/assets/gifs/explore.gif',
  'Explore Area': '/UAS-PTI/assets/gifs/explore.gif',
  'Pray': '/UAS-PTI/assets/gifs/doa.gif',
  'Go to Home': '/UAS-PTI/assets/gifs/travel.gif',
  'Go to Mountain': '/UAS-PTI/assets/gifs/travel.gif',
  'Go to Lake': '/UAS-PTI/assets/gifs/travel.gif',
  'Go to Beach': '/UAS-PTI/assets/gifs/travel.gif',
  'Go to Temple': '/UAS-PTI/assets/gifs/travel.gif',
  'Go to MainMap': '/UAS-PTI/assets/gifs/travel.gif',
};
