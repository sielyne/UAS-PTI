...
const MountainActivities = ({ onActivity }) => {
  return (
    <>
      <div className="activity-option">
        <span className="info-icon" title="Work at Mountain to earn +Rp1.000.000. This action will consume -20 Energy, -15 Hygiene, -15 Hunger">
          i
        </span>
        <button onClick={() => onActivity('Work')}>Work</button>
      </div>
      <div className="activity-option">
        <span className="info-icon" title="Eat at restaurant in Mountain to earn +40 Hunger, +10 Happiness and +10 Energy. This action will consume -Rp100.000!">
          i
        </span>
      ...
      <div className="activity-option">
        <span className="info-icon" title="Explore Mountain to earn +25 Happiness. This action consume -20 Energy and -10 Hygiene">
          i
        </span>
